...
import com.change.unlock.diy.BuildConfig;
...
public class ProcessDataContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = BuildConfig.APPLICATION_ID + ".ProcessDataContentProvider";
    ...
    public static final String STRING_SP_URI = "content://" + AUTHORITY + "/sp/";
    public static final Uri SP_URI = Uri.parse(STRING_SP_URI + "1");
